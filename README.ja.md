...
手動で試した範囲では、母音の影響が子音よりも大きく、vowel_ratio=0に設定しても、子音の一致が優先されない傾向が見られました。これは、日本語では母音がカナの音韻を特徴づけることが多いため、日本語の音響モデルに基づくこのデータでも同様の傾向が見られると考えられます。子音の一致を重視したい場合は、重みなしの編集距離を使用することが適しているかもしれません。
